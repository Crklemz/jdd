...
export const consultingContent: ConsultingContent = {
  ...
  questionBullets: [
    ...
    "Do you wish to grow your event and reach its next attendance level?",
  ],
  problemStatement:
  ...
  getPackage: {
    ...
    phases: [
      {
        roman: "I",
        title: "GROW your event to its next audience level:",
        items: [
          "Audience growth strategy + demographic analysis + differentiation blueprint",
        ],
      },
      {
        roman: "II",
        title: "EVOLVE into a cohesive community:",
        items: [
          "Community architecture design + leader presence doctrine + retention systems",
        ],
      },
      {
        roman: "III",
        title: "TRANSFORM your core program to reach a new energy level:",
        items: [
          "Program redesign + energy arc optimization + systems modernization",
        ],
      },
    ],
    deliverables: [
      "Strategic roadmap document",
      "Live consulting sessions per month",
      "Event audit & after-action analysis",
      "Implementation checklist",
    ],
    tagline:
      "Become the talk of town with G.E.T.'s continuously improving & upward spiral upgrade.",
  },
  ideaSession: {
  ...
  valueBoxes: [
    {
      title: "Unrivaled professionalism (above the industry standard)",
      description:
        "Structured diagnostics, measurable KPIs, and strategic implementation plans.",
    },
    {
      title: "Unmatched vision & execution",
      description:
        "Concept-to-execution oversight across branding, programming, staffing, and experience flow.",
    },
    {
  ...
  comingSoonItems: [
    "Spirituality (Carpe Diem Coaching)",
    "Cannabis Science (CannaBliss)",
    "Herbalism (Alchemical Synergy)",
    "Tantra (Presence, play & pleasure)",
    "Artificial Intelligence (Altruistic Intelligences)",
  ],
  sectionImagePaths: [],
